...
#Add Adopters
adopter1 = Adopter(name = "Person1")
session.add(adopter1)
adopter2 = Adopter(name = "Person2")
session.add(adopter2)
adopter3 = Adopter(name = "Person3")
session.add(adopter3)
adopter4 = Adopter(name = "Person4")
session.add(adopter4)
adopter5 = Adopter(name = "Person5")
session.add(adopter5)
adopter6 = Adopter(name = "Person6")
session.add(adopter6)
adopter7 = Adopter(name = "Person7")
session.add(adopter7)
adopter8 = Adopter(name = "Person8")
session.add(adopter8)
adopter9 = Adopter(name = "Person9")
session.add(adopter9)
adopter10 = Adopter(name = "Person10")
session.add(adopter10)

#Add Shelters
pup_max = randint(10,30)
shelter1 = Shelter(name = "Oakland Animal Services", address = "1101 29th Ave", city = "Oakland", state = "California", zip_code = "94601", website = "oaklandanimalservices.org", maximum_capacity = pup_max, current_occupancy = (pup_max - randint(0,10)))
session.add(shelter1)

pup_max = randint(10,30)
shelter2 = Shelter(name = "San Francisco SPCA Mission Adoption Center", address="250 Florida St", city="San Francisco", state="California", zip_code = "94103", website = "sfspca.org", maximum_capacity = pup_max, current_occupancy = (pup_max - randint(0,10)))
session.add(shelter2)

pup_max = randint(10,30)
shelter3 = Shelter(name = "Wonder Dog Rescue", address= "2926 16th Street", city = "San Francisco", state = "California" , zip_code = "94103", website = "http://wonderdogrescue.org", maximum_capacity = pup_max, current_occupancy = (pup_max - randint(0,10)))
session.add(shelter3)

pup_max = randint(10,30)
shelter4 = Shelter(name = "Humane Society of Alameda", address = "PO Box 1571" ,city = "Alameda" ,state = "California", zip_code = "94501", website = "hsalameda.org", maximum_capacity = pup_max, current_occupancy = (pup_max - randint(0,10)))
session.add(shelter4)

pup_max = randint(10,30)
shelter5 = Shelter(name = "Palo Alto Humane Society" ,address = "1149 Chestnut St." ,city = "Menlo Park", state = "California" ,zip_code = "94025", website = "paloaltohumane.org", maximum_capacity = pup_max, current_occupancy = (pup_max - randint(0,10)))

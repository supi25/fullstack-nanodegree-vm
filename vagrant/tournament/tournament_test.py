...
def testStandingsBeforeMatches():
    ...
    [(id1, name1, wins1, matches1, omw1), (id2, name2, wins2, matches2, omw1)] = standings
...
def testReportMatches():
    ...
    for (i, n, w, m, o) in standings:
        ...
        if i in (id1, id3) and o != 0:
            raise ValueError("Each match winner should have zero opponent match wins.")
        elif i in (id2, id4) and o != 1:
            raise ValueError("Each match loser should have one opponent match win.")
    ...
    for (i, n, w, m, o) in standings:
        ...
        if o != 0:
            raise ValueError("After deleting matches, players should have zero opponent match wins.")
